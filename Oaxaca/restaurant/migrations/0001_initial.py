# Generated by Django 4.0.5 on 2023-02-06 13:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_name', models.CharField(choices=[('Order in progress', 'Inprogress'), ('Received', 'Received'), ('Cooking', 'Cooking'), ('Problem', 'Problem')], default='Order in progress', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
